...
var Door1_4to1_5 = new Door(Screen1_4, 150, 10, 400, 0, Screen1_5, ['location',25,550]);
var Door1_5to1_4 = new Door(Screen1_5, 150, 10, 0, 630, Screen1_4, ['location',450,15]);
//Level transition door
var Door1_5to2_1 = new Door(Screen1_5, 150, 10, 400, 0, Screen1_5,['location',25,550],locked=true);
...
var key1 = new Key(gameInstance, 48, 48, 400, 250, '../static/img/newKey.png', Door1_1to1_2,message="Good! Now go through the door on the right");
...
var ctrl = new MessageArea(gameInstance, 48, 48, 150, 300, '../static/img/practiceKey.jpg', false, "FYI, you move with the arrow keys");
var ctrl1 = new MessageArea(gameInstance, 48, 48, 350, 300, '../static/img/practiceKey.jpg', false, "Just so we're clear, you move with the arrow keys");
var ctrl2 = new MessageArea(gameInstance, 48, 48, 550, 300, '../static/img/practiceKey.jpg', false, "To avoid any confusion, you move with the arrow keys");
var ctrl3 = new MessageArea(gameInstance, 48, 48, 750, 300, '../static/img/practiceKey.jpg', false, "Did you know that you move with the arrow keys?");
...
var speakBox = new MessageArea(gameInstance, 48, 48, 150, 300, '../static/img/practiceKey.jpg', false, "Type in 'speak' then what you want to say in double quotes");
var speakBox1 = new MessageArea(gameInstance, 48, 48, 750, 300, '../static/img/practiceKey.jpg', false, "Try speaking \"hello\"");
