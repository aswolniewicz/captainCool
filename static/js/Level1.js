...
var testDoor = new Door(Screen1_1, 10, 150, 0, 250,Screen1_4,['location',25,550],locked=true);
...
var Door1_2to1_3 = new Door(Screen1_2, 10, 150, 950, 250,Screen1_3, ['location',425,550]);
...
var controlsBox = new MessageArea(gameInstance, 48, 48, 250, 300, '../static/img/practiceKey.jpg', false, "Just so you know: You move with the arrow keys");

Screen1_2.addDrawable([controlsBox,Wall1_2_2,Wall1_2_1]);

// Objects in Screen 3
var Wall1_3_1 = new Obstacle(gameInstance, 450, 640, 550,0);
var Wall1_3_2 = new Obstacle(gameInstance, 400, 640, 0, 0);

Screen1_3.addDrawable([Wall1_3_2, Wall1_3_1]);
// Start screen
